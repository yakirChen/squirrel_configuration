...
export TOSHIBA=/Volumes/Toshiba
export TOSHIBA_REPOS=/Volumes/Toshiba/repos
export TOSHIBA_SERVERS=/Volumes/Toshiba/servers
...
export NODE_GLOBAL_PATH=${TOSHIBA_REPOS}/node_global
#export RUST_HOME=${LOCAL}/rust
export CARGO_HOME=${TOSHIBA_REPOS}/cargo
...
#export CLANG_HOME=${TOSHIBA_REPOS}/clang
...
# export OPAMROOT=${TOSHIBA_REPOS}/opam
# export OCAML_TOPLEVEL_PATH=${TOSHIBA_REPOS}/ocaml
# export COREUTILS=${LOCAL}/coreutils
export GOPATH=${TOSHIBA_REPOS}/go/gopath
export GOCACHE=${TOSHIBA_REPOS}/go/gocache

# 服务
#export ZK_HOME=${TOSHIBA}/Developer/zookeeper
export ZK_HOME=${LOCAL}/zookeeper
export TOMCAT_HOME=${TOSHIBA_SERVERS}/tomcat
export REDIS_HOME=${TOSHIBA_REPOS}/redis
export KOTLIN_NATIVE_HOME=${TOSHIBA_REPOS}/kotlin-native
...
export CHEZ_SCHEME_HOME=${TOSHIBA_SERVERS}/chez_scheme
...
# repos
export HASKELL_BIN=${TOSHIBA_REPOS}/haskell
export GRADLE_USER_HOME=${TOSHIBA_REPOS}/gradle
export GEM_HOME=${TOSHIBA_REPOS}/gem
...
export JFX_HOME=${TOSHIBA_SERVERS}/openjfx
...
#export JAVA_OPTS="${DEF_JAVA_OPTS} --illegal-access=deny -XX:HeapDumpPath=${TOSHIBA_REPOS}/logs/jvm_error.hprof"
export JAVA_OPTS="${DEF_JAVA_OPTS} -XX:HeapDumpPath=${TOSHIBA_REPOS}/logs/jvm_error.hprof"
#export MAVEN_OPTS="${DEF_JAVA_OPTS} -XX:HeapDumpPath=${TOSHIBA_REPOS}/logs/maven_java_error.hprof"
export ANT_ARGS="-nouserlib -lib ${TOSHIBA_REPOS}/ant/lib"
...
PATH=${SPRINGCLI_HOME}/bin:${FFMPEG_HOME}/bin:${GNUPG_HOME}/bin:$PATH
...
alias mvna="mvn dependency:sources ; mvn dependency:resolve -Dclassifier=javadoc ; ${MVN_TEMPLATE} -P163 -Pmaven2 ; mvn clean"

alias mx="mx --user-home=${TOSHIBA_REPOS}/mx"
...
source $ZSH/oh-my-zsh.sh
 ...
 # OPAM configuration
. ${TOSHIBA_REPOS}/opam/opam-init/init.zsh > /dev/null 2> /dev/null || true
